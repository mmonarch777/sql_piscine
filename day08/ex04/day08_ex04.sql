...
begin transaction isolation level serializable ;/*1 -Устанавливаем уровень изоляции транзакции-*/
...
-- Сессия_2
-- ------------Начало транзакции(begin)---------------------
begin transaction isolation level serializable ;/*2 -Устанавливаем уровень изоляции транзакции-*/
update pizzeria set rating=3.0 where name='Pizza Hut';/*4 -Меняем данные в таблице-*/
commit;/*5*/
-- ------------Конец транзакции(commit)---------------------
